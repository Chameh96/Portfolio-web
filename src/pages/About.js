    ...
    return (
      <section className='about'>
        ...
        <div className='about-text'>
          <h2>About Me</h2>
          <h4>History</h4>
          <p>I have worked in various fields, all of which have taught me valuable lessons. As a waiter taught me how to work hard, with some shifts being 18hours and putting up with some less than enjoyable customers enforced the ability to turn the other cheek and get on with my job. 
...
Lastly my Advertising strategy job, through this I solidified my time management skills, client management and working as a team. Having to organise markets across Europe, the Middle-East and Africa to work on regional releases.
          ...
          <p>I have always been interested in the tech world, specifically in coding. Then a friend sent me a link to a Saturday free coding course, and I absolutely fell in love with it. The problem solving aspect and the conciseness of the coding world really resonate with me. </p>
